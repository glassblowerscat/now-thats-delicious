...
// 1. See if a user with that email exists
  ...
  if (!user) {
    req.flash('success', 'A password reset has been mailed to your email address.');
  ...
  req.flash('success', `A password reset has been mailed to your email address. ${resetURL}`);
